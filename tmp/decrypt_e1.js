...
https.get('https://megaplay.buzz/lib/e1-player.min.js?v=2.20', {
    ...
    res.on('end', () => {
        ...
        fs.writeFileSync('/tmp/e1_decrypted.js', decrypted);
        console.log('Saved to /tmp/e1_decrypted.js');
    });
});
